...
const navItems = [
    ...
    { href: "/patient", label: "Check-in", Icon: ClipboardIcon },
        ...
        <aside className="fixed left-0 top-0 z-40 h-screen w-64 glass-card border-r transition-transform -translate-x-full md:translate-x-0">
            <div className="flex flex-col h-full">
                ...
                <div className="flex items-center gap-3 px-6 py-5 border-b border-border/50">
                    ...
                    <div>
                        <h1 className="font-bold text-lg">NoShowIQ</h1>
...
export function MobileNav() {
    ...
    return (
        <nav className="fixed bottom-0 left-0 right-0 z-40 glass-card border-t md:hidden">
